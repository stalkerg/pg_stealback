...
#============================================================================
# This is a test script for purge command of pg_arman.
#============================================================================
...
pg_arman purge -B ${BACKUP_PATH} > ${TEST_BASE}/TEST-0001.out.3 2>&1
pg_arman show -a -B ${BACKUP_PATH} > ${TEST_BASE}/TEST-0001.out.4 2>&1
...
pg_arman purge -B ${BACKUP_PATH} --check > ${TEST_BASE}/TEST-0002.out.3 2>&1
pg_arman show -a -B ${BACKUP_PATH} > ${TEST_BASE}/TEST-0002.out.4 2>&1
